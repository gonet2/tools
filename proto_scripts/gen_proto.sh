...
go run api.go --template "templates/client/api.tmpl" --min 0 --max 65535 > $PATH_CLIENT/NetApi.cs
...
go run proto.go --template "templates/client/proto.tmpl" > $PATH_CLIENT/NetProto.cs
